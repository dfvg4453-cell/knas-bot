...
# الفئات والأسعار تماماً كما بالصورة
CATEGORIES = {
...
def get_buy_menu():
    ...
    # إضافة الأقسام والأسعار والكميات بشكل عمودي مثل الصورة
    ...
    # زر AUTO تماماً مثل الصورة
    markup.add(types.InlineKeyboardButton("AUTO", callback_data="buy_auto"))
...
def start_cmd(message):
    ...
    try:
        sent_rem = bot.send_message(chat_id, ".", reply_markup=types.ReplyKeyboardRemove())
        bot.delete_message(chat_id, sent_rem.message_id)
    except Exception:
        pass
...
def callback_listener(call):
    ...
    # زر AUTO (رقم عشوائي مجاني بدون خصم رصيد)
        ...
        text = f"✅ **تم تجهيز الرقم لك (عشوائي مجاني):**\n\n📱 الرقم: `+{phone}`\n💰 السعر: **مجاناً (0$)**"
